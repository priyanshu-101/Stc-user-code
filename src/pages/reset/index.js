    ...
    return (
      ...
      <div className="primary-bg  form-container">
        ...
        <MDBInputGroup className="login-form-group">
          <MDBInput label="New Password" type="password" onChange={(e)=>{setpassword(e.target.value)}} value={password}/>
        </MDBInputGroup>

      

        <MDBInputGroup className="login-form-group">
          <MDBBtn  onClick={(e)=> passwordChange(e)} className=" btn-block login-form-btn">
            Change Password
          </MDBBtn>
