...
const CompanyReports = ({ id }) => {
  ...
  useEffect(async () => {
    ...
    setVerticalActive(verticalActive);
          ...
          <MDBTabsContent>
            <div className="details-pane">
              <div className="company-logo">
                ...
                <img
                  src={`https://drive.google.com/uc?export=view&id=${data?.ImageID}`}
              ...
              {data ? (
                <>
                  ...
                  {data.companyFirstRoundDescrip != "NA" &&
                    data.companyFirstRoundDescrip != "N/A" &&
                    data.companyFirstRoundDescrip != " " &&
                    data.companyFirstRoundDescrip && (
                      <div>
                  ...
                  {data.companySecondRoundDescrip != "NA" &&
                    data.companySecondRoundDescrip != "N/A" &&
                    data.companySecondRoundDescrip != " " &&
                    data.companySecondRoundDescrip && (
                      <div>
                        <b>{data.companySecondRoundName}</b> :{" "}
                        {data.companySecondRoundDuration != "NA" &&
                          data.companySecondRoundDuration != "N/A" &&
                          data.companySecondRoundDuration != " " && (
                            <span>
                  ...
                  {data.companyThirdRoundDescrip != "NA" &&
                    ...
                    data.companyThirdRoundDescrip != " " &&
                    data.companyThirdRoundDescrip && (
                      <div>
                        <b>{data.companyThirdRoundName}</b> :{" "}
                        {data.companyThirdRoundDuration != "NA" &&
                          data.companyThirdRoundDuration != "N/A" &&
                          data.companyThirdRoundDuration != " " && (
                            <span>
                  ...
                  {data.companyFourthRoundDescrip != "NA" &&
                    data.companyFourthRoundDescrip != "N/A" &&
                    data.companyFourthRoundDescrip != " " &&
                    data.companyFourthRoundDescrip && (
                      <div>
                        <b>{data.companyFourthRoundName}</b> :{" "}
                        {data.companyFourthRoundDuration != "NA" &&
                          data.companyFourthRoundDuration != "N/A" &&
                          data.companyFourthRoundDuration != " " &&
                          data.companyFourthRoundDuration && (
                            <span>
                  ...
                  {data.companyAdditionalRoundDescrip != "NA" &&
                    data.companyAdditionalRoundDescrip != "N/A" &&
                    data.companyAdditionalRoundDescrip != " " &&
                    data.companyAdditionalRoundDescrip && (
                      <div>
